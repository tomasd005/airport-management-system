...
void gestor_reservas_para_cada(gestor_reservas_t *gestor, void (*callback)(reserva_t *, void *), void *user_data);
void gestor_reservas_para_cada_com_semana(gestor_reservas_t *gestor, gestor_voos_t *gestor_voos, void (*callback)(int semana, reserva_t *, void *), void *user_data);
void gestor_reservas_para_cada_semana(gestor_reservas_t *gestor, gestor_voos_t *gestor_voos, const char *data_inicio, const char *data_fim, void (*callback)(int semana, reserva_t *, void *), void *user_data);
